...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT(
  //,--------+--------+--------+--------+--------+--------+--------.        ,--------+--------+--------+--------+--------+--------+--------.
     KC_GRV,  KC_F9,   KC_F10,  KC_F11,  KC_F12,  FOCUSMD, TABU,             VIMTABU, _______, _______, CHKESC,  _______, _______, KEYPAD,
  //|--------+--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+--------+--------|
     _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   CTL_U,   TABD,             VIMTABD, _______, AUTOFIL, TMUXPRF, TABU,    TABD,    _______,
  //|--------+--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+--------+--------|
  ...
  [_KEYPAD] = LAYOUT(
  //,--------+--------+--------+--------+--------+--------+--------.        ,--------+--------+--------+--------+--------+--------+--------.
     _______, _______, KC_P7,   KC_P8,   KC_P9,   _______, TABU,             VIMTABU, _______, KC_P7,   KC_P8,   KC_P9,   KC_PSLS, KC_PSLS,
  //|--------+--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+--------+--------|
     KC_BSPC, _______, KC_P4,   KC_P5,   KC_P6,   _______, TABD,             VIMTABD, _______, KC_P4,   KC_P5,   KC_P6,   KC_PAST, KC_PMNS,
  //|--------+--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+--------+--------|
     _______, _______, KC_P1,   KC_P2,   KC_P3,   _______, DVORAK,           DVORAK,  _______, KC_P1,   KC_P2,   KC_P3,   KC_UP,   KC_PPLS,
  //|--------+--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+--------+--------|
     _______, _______, KC_PDOT, KC_P0,            _______, _______,          KC_PENT, KC_PDOT,          KC_P0,   KC_LEFT, KC_DOWN, KC_RGHT 
  //`--------+--------+--------+--------+--------+--------+--------/        \--------+--------+--------+--------+--------+--------+--------'
  )
};
