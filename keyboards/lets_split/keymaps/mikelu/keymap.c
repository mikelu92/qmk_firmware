 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Raise |Adjust| Alt  | GUI  |Lower |Space |Enter |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 *
 *  Hold
 * ,-----------------------------------------------------------------------------------.
...
[_DVORAK] = KEYMAP( \
  ...
  TAP_RSE, ADJUST,  KC_LALT, KC_LGUI, LOWER,   KC_SPC,  SFT_ENT, RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
