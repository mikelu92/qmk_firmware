 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Del  |  F5  |  F6  |  F7  |  F8  | End  | PgDn |   4  |   5  |   6  |   *  |  _   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |  F1  |  F2  |  F3  |  F4  |      |      |   1  |   2  |   3  |   -  |  +   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      |   0  |   .  | Entr |      |
 ...
 */
[_RAISE] = KEYMAP( \
  KC_TILD, KC_F9,   KC_F10,  KC_F11,  KC_F12 , KC_HOME, KC_PGUP, KC_P7,   KC_P8,   KC_P9,   KC_PSLS, KC_QUES, \
  KC_BSPC, KC_F5,   KC_F6,   KC_F7,   KC_F8  , KC_END,  KC_PGDN, KC_P4,   KC_P5,   KC_P6,   KC_PAST, KC_UNDS, \
  KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4  , _______, _______, KC_P1,   KC_P2,   KC_P3,   KC_PMNS, KC_PLUS, \
